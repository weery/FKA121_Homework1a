...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.40\textwidth}
        \centering
        \resizebox{\columnwidth}{!}{\input{graphics/task3/pressure500.tikz}}
    \end{subfigure}
    \begin{subfigure}[b]{0.40\textwidth}
        \centering
        \resizebox{\columnwidth}{!}{\input{graphics/task3/temperature500.tikz}}
    \end{subfigure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.40\textwidth}
        \centering
        %\resizebox{\columnwidth}{!}{\input{graphics/task4/traj.tikz}}
    \end{subfigure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.40\textwidth}
        \centering
        %\resizebox{\columnwidth}{!}{\input{graphics/task8/integral.tikz}}
    \end{subfigure}
    \begin{subfigure}[b]{0.40\textwidth}
        \centering
        %\resizebox{\columnwidth}{!}{\input{graphics/task4/temperature700.tikz}}
    \end{subfigure}
    \caption{}
