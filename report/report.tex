...
The radial distribution function obtained can be found in figure~\ref{fig:radial}. Using Matlab we find that the first peak is at the distance 2.85 \r{A}, which corresponds to the closest distance between two aluminium atoms (shortest distance in a fcc structure with the unit cell length of 4.046 \r{A}). This is expected. The other peaks
